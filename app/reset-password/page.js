    ...
    <div style={{ minHeight: '100vh', background: '#0A0A0A', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
      <div style={{ width: '100%', maxWidth: '400px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          ...
          <h1 style={{ fontSize: '22px', fontWeight: 700, color: '#F5EDE8', margin: 0 }}>Nouveau mot de passe</h1>
          <p style={{ fontSize: '14px', color: '#8C7570', marginTop: '6px' }}>Choisis un nouveau mot de passe</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div>
            <label style={{ display: 'block', fontSize: '13px', fontWeight: 500, color: '#8C7570', marginBottom: '6px' }}>Nouveau mot de passe</label>
